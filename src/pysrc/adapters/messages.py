...
class SnapshotMessage:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SnapshotMessage):
            return False
        return (
            self.time == other.time
            and self.feedcode == other.feedcode
    ...
    def __repr__(self) -> str:
        return (
            f"SnapshotMessage(time={self.time}, feedcode='{self.feedcode}', bids={self.bids}, "
            f"asks={self.asks}, market={self.market})"
        )
...
class TradeMessage:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self.time == other.time
            and self.feedcode == other.feedcode
            and self.n_trades == other.n_trades
    ...
    def __repr__(self) -> str:
        return (
            f"TradeMessage(time={self.time}, feedcode='{self.feedcode}', n_trades={self.n_trades}, "
